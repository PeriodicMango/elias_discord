...
import { DISCORD_TOKEN, PATHS } from "../../../eliasCore/src/config.js";
import { clearHistory, tempHistoryPath } from "../../../eliasCore/src/helpers/history.js";
...
import { listPersonas, getPersonaTriggers, clearPersonaCache } from "../../../eliasCore/src/helpers/personas.js";
import { getMasterId } from "../../../eliasCore/src/helpers/auth.js";
    ...
    options: [
      {
        ...
        type: 1,
        options: [
          { name: "name", description: "模型名，如 deepseek-v4-pro[1m]", type: 3, required: true },
        ],
      },
      {
        name: "url",
  ...
  switch (interaction.commandName) {
    ...
    case "history": {
      ...
      try {
        ...
        await interaction.editReply(`读取历史失败：${err}`);
      }
      break;
    }
    case "status": {
